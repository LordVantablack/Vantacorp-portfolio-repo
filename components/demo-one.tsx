...
export function DemoOne() {
  return (
    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden h-[800px]">
      <div className="absolute inset-0 z-0">
        <WebGLShader/> 
      </div>
      <div className="relative z-10 border border-[#27272a] bg-black/50 p-2 w-full mx-auto max-w-3xl backdrop-blur-sm">
      <main className="relative border border-[#27272a] bg-black/30 py-10 overflow-hidden">
